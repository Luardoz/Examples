...
/**
 * <p>Clase Java para listaParametrosType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listaParametrosType">
 *   &lt;complexContent>
...
@XmlType(name = "listaParametrosType", propOrder = {
    "parametro"
})
public class ListaParametrosType {

    @XmlElement(required = true)
    protected List<ListaParametrosType.Parametro> parametro;
     ...
     * {@link ListaParametrosType.Parametro }
     * 
     * 
     */
    public List<ListaParametrosType.Parametro> getParametro() {
        if (parametro == null) {
            parametro = new ArrayList<ListaParametrosType.Parametro>();
        }
